...
const EducationTimeline = () => {
  ...
  window.addEventListener("switchTimelineTab", handleSwitchTab);

  return () => {
    window.removeEventListener("switchTimelineTab", handleSwitchTab);
  };
  ...
  const educationData = [
    {
      ...
      title: "SSC",
      year: "2017",
      subtitle: "Sandeepani Public School, Nanded",
      description:
        "Completed SSC with 84.20% under Latur Board with strong academic performance.",
    },
    {
      icon: <FaUniversity />,
      title: "HSC",
      year: "2019",
      subtitle: "N.E.S Science College, Nanded",
      description:
        "Completed Higher Secondary Education under Latur Board.",
    },
    {
      icon: <GiDiploma />,
      title: "Diploma in CSE",
      year: "2021",
      subtitle: "AGPCE Nagpur",
      description:
        "Completed Diploma in Computer Science Engineering with 82% under MSBTE.",
    },
    {
      icon: <FaUserGraduate />,
      title: "B.Tech in CSE",
      ...
      description:
        "Graduated in Computer Science & Engineering with 8.02 CGPA from Nagpur University.",
    },
  ];
  ...
  const experienceData = [
    {
      ...
      subtitle: "Teachnook",
      description:
        "Worked on responsive web interfaces using HTML, CSS, JavaScript and frontend development concepts.",
    },

    {
      ...
      year: "2025",
      subtitle: "The Kiran Academy",
      description:
        "Built enterprise-level full-stack applications using Java, Spring Boot, Angular, Hibernate, REST APIs and MySQL.",
    },

    {
      ...
      year: "2025",
      subtitle: "Vedanit IT Technologies",
      description:
        "Worked on real-world Java Full Stack development projects involving Spring Boot backend development, Angular frontend integration, REST API handling, authentication modules and database connectivity.",
    },

    {
      icon: <FaCode />,
      title: "DSA & Full Stack Development",
      year: "Present",
      subtitle: "Self Learning & Personal Projects",
      description:
        "Actively solving LeetCode problems and developing scalable full-stack projects including Taskora, ClimeX and Employee Management System.",
    },
  ];
