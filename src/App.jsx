      ...
      <div className="carousel-3d" id="projectCarousel">
        ...
        <div className="carousel-item-cyber">
          <div className="card-cyber text-center">
            <img src="https://placehold.co/600x400/1a202c/6b7280?text=TASKORA" className="img-fluid mb-3" alt="Taskora Project" />
        ...
        <div className="carousel-item-cyber">
          <div className="card-cyber text-center">
            <img src="https://placehold.co/600x400/1a202c/6b7280?text=CLIMEX" className="img-fluid mb-3" alt="ClimeX Weather App" />
        ...
        <div className="carousel-item-cyber">
          <div className="card-cyber text-center">
            <img src="https://placehold.co/600x400/1a202c/6b7280?text=SOCIAL+APP" className="img-fluid mb-3" alt="Social Media Post Manager" />
